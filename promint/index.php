...
require_once __DIR__ . '/modules/auth/UserController.php';
require_once __DIR__ . '/modules/auth/TransactionController.php';
...
switch ($request) {
    ...
    case '/admin/flagged-transactions' :
        require __DIR__ . '/modules/admin/flagged-transactions.php';
        break;
